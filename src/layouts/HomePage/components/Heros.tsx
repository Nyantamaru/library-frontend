      ...
      <div className="d-none d-lg-block">
        <div className="row g-0 mt-5">
          ...
          <div className="col-4 col-md-4 container d-flex justify-content-center align-items-center">
            <div className="ml-2">
              <h1>Wha have you been reding?</h1>
              <p className="lead">
                The library team would love to know what you have been reading.
                Wheather it is to learn a new skill or grow Within one, we will
        ...
        <div className="row g-0">
          <div className="col-4 col-md-4 f-flex justify-content-center align-items-center">
            <div className="ml-2">
              <h1>Our collection is always changing!</h1>
              <p className="lead">
                Try to check in daily as our collection is always changing! We
                work nonstop to provide the most accurate book selection posible
            ...
            <div className="col-image-right">
              <div className="mt-2">
                ...
                <p className="lead">
                  ...
                  posible for our Luv 2 Read students! We are diligent about our
